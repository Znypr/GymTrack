...
internal object BackupFixtures {
    fun payload() = GymTrackBackupPayload(
        ...
        canonicalWorkouts = listOf(CanonicalWorkoutEntity("workout", 100L, 100L, 200L, "cat", "Workout", "Good", "COMPLETED", null, null, null, 100L, 200L)),
        canonicalWorkoutExercises = listOf(CanonicalWorkoutExerciseEntity("we", "workout", "ex", 0, "BILATERAL", null, null, 0, 100L, null, null)),
        canonicalWorkoutSets = listOf(CanonicalWorkoutSetEntity("set", "we", 0, 5, 100.0, "KG", null, null, 10, 8.0, 2.0)),
    )
}
