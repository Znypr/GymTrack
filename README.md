...
GitHub Issues, existing labels, linked pull requests, and CI checks are the live source of truth for current work. No separate GitHub Project board is required or authoritative.
